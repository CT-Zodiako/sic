...
export class NavigationMenuComponent {
  private readonly icons: Record<string, string> = {
    ...
    'Acueducto': 'water_drop',
    'Agua': 'water_drop',
    'Energía': 'bolt',
    'Gas': 'local_fire_department',
    'Tarifas': 'request_quote',
    'Inventario': 'inventory_2',
    'Lecturas': 'menu_book',
    'Cobros': 'payments',
  };
  iconFor(node: { label?: string }) { return this.icons[node.label ?? ''] ?? 'chevron_right'; }
